...
class GetMilestoneDashboardDataTest {
  ...
  private GetMilestoneDashboardData underTest;

  @BeforeEach
  void setUp() {
    this.underTest = new GetMilestoneDashboardData(this.repository);
  }
  ...
  void test1() {
    ...
    // when
    final MilestoneDataChart milestone = this.underTest.get(new DashboardDataParameters(
      true,
      1L,
      1L,
      yearMonth,
