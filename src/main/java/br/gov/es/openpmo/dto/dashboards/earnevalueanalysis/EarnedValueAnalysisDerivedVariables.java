...
public class EarnedValueAnalysisDerivedVariables {
  ...
  public BigDecimal getEstimateToComplete(final BigDecimal plannedValueAtCompletion) {
    if(this.variables == null) {
      return null;
    }
  ...
  public BigDecimal getEstimateAtCompletion(final BigDecimal plannedValueAtCompletion) {
