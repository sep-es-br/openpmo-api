...
public class LocalityService {
  ...
  public Locality findById(final Long id) {
    return this.localityRepository.findById(id).orElseThrow(
      () -> new NegocioException(LOCALITY_NOT_FOUND));
  }
  ...
  public Locality findByIdWithParent(final Long id) {
    return this.localityRepository.findByIdWithParent(id).orElseThrow(
      () -> new NegocioException(LOCALITY_NOT_FOUND));
  }
