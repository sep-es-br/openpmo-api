...
public class WorkpackService implements BreadcrumbWorkpackHelper {
  ...
  private void cancelWorkpack(final Workpack workpack) {
    // TODO O cancelamento de um workpack deve gerar um evento do tipo Edition no Journal.
  ...
  private void restoreWorkpack(final Workpack workpack) {
    // TODO A restauração de um workpack cancelado deve gerar um evento do tipo Edition no Journal.
