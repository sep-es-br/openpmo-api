...
public class JournalCreator {
  ...
  public void baseline(final Baseline baseline, final Long personId) {
    ...
    final JournalAction journalAction = JournalActionMapper.map(baseline);
  ...
  public JournalEntry create(
    ...
    final Workpack workpack = this.findWorkpackById(workpackId);
  ...
  public void newInformation(
    ...
    final Long personId,
    final String description,
    final List<EvidenceRequest> evidences
  ) {
  ...
  public void issue(final Issue issue, final Long personId) {
    ...
    final JournalAction journalAction = JournalActionMapper.map(issue);
  ...
  public void issueResponse(final IssueResponse issueResponse, final Long personId) {
    ...
    final JournalAction journalAction = JournalActionMapper.map(issueResponse);
  ...
  public void risk(final Risk risk, final Long personId) {
    ...
    final JournalAction journalAction = JournalActionMapper.map(risk);
  ...
  public void riskResponse(final RiskResponse riskResponse, final Long personId) {
    ...
    final JournalAction journalAction = JournalActionMapper.map(riskResponse);
