...
public class EDocsApiImpl implements EDocsApi {
    ...
    public ProcessResponse findProcessByProtocol(final String protocol, final Long idPerson) {
        ...
        boolean processPriority = this.isProcessPriority(processResponse.getId(), idPerson);
    ...
    @Override
    public boolean isProcessPriority(String processId, Long personId) {
        String uri = this.edocsUriWebApi.concat("/v2/processos/").concat(processId).concat("/sinalizacao");
