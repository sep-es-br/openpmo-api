...
public interface IAcessoCidadaoApi {
  ...
  Optional<PublicAgentEmailResponse> findAgentEmail(
    String sub,
    Long idPerson
  );

  Optional<PublicAgentResponse> findPublicAgentBySub(
    String sub,
    Long idPerson
  );

  Optional<String> findSubByCpf(
    String cpf,
    Long idPerson
  );
