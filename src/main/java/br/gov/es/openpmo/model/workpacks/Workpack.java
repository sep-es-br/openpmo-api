...
public class Workpack extends Entity implements Snapshotable<Workpack> {
  ...
  public boolean hasLinkedTo() {
    return this.linkedTo != null && !this.linkedTo.isEmpty();
  }
  ...
  public boolean isCancelable() {
    // TODO O workpack não deve conter entre seus descendentes workpacks padrão project
    //  com linha de base vigente e ativos (não cancelado).
    // TODO O workpack deve estar presente na linha de base vigente de algum ascendente.
    this.isCancelable = this.canBeCanceled();
  ...
  public void setCancelable(final boolean cancelable) {
    // TODO Workpacks cancelados são desconsiderados nos cálculos totalizadores de todos os seus ascendentes.
    // TODO Workpacks restaurados voltam a ser considerados nos cálculos totalizadores de todos os seus ascendentes.
  ...
  @Transient
  public void addCost(final CostAccount costAcount) {
    if(this.costs == null) {
      this.costs = new HashSet<>();
    }
    this.costs.add(costAcount);
    costAcount.setWorkpack(this);
  }
