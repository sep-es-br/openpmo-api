...
public interface IsCCBMemberRepository extends Neo4jRepository<IsCCBMemberFor, Long> {
    ...
    @Query("MATCH (p:Person)-[c:IS_CCB_MEMBER_FOR]->(w:Workpack) " +
            ...
            "RETURN p,c,w")
    List<IsCCBMemberFor> findByPersonIdAndWorkpackId(Long idPerson, Long idWorkpack);
    ...
    List<IsCCBMemberFor> findByPersonIdAndWorkpackIdAndPlanId(Long idPerson, Long idWorkpack, Long idPlan);
    ...
    List<IsCCBMemberFor> findAllByPersonIdAndWorkpackId(Long idPerson, Long idWorkpack);
    ...
    @Query("MATCH (p:Person)-[c:IS_CCB_MEMBER_FOR]->(:Workpack)-[:BELONGS_TO]->(:Plan)-[:IS_ADOPTED_BY]->(o:Office) " +
            ...
            "DETACH DELETE c")
    void deleteAllByPersonIdAndOfficeId(Long idPerson, Long idOffice);
}
