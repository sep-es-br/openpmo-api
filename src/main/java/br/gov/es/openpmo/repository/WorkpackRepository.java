...
public interface WorkpackRepository extends Neo4jRepository<Workpack, Long>, CustomRepository {
  ...
  @Param("idPlanModel")
  Long idPlanModel,
  @Param("idWorkPackModel")
  Long idWorkPackModel,
  @Param("term")
  String term,
  @Param("searchCutOffScore")
  ...
  @Param("idWorkpack") Long idWorkpack,
  @Param("sharedPublicStatus")
  Boolean $sharedPublicStatus,
  @Param("publicLevel")
  String $publicLevel);
  ...
  void setWorkpacksDeleted(
      @Param("idsWorkpacks") List<Long> idsWorkpacks,
      @Param("deleted") Boolean deleted);"WHERE id(w) IN $idsWorkpacks "+"SET w.deleted = $deleted")
  ...
  @Query("MATCH (w:Workpack)-[:BELONGS_TO]->(plan:Plan) " +
      "WHERE ID(w) = $idWorkpack " +
      "RETURN plan ")
