...
public interface OfficePermissionRepository extends Neo4jRepository<CanAccessOffice, Long>, CustomRepository {
    ...
    boolean hasCanAccessPlan(@Param("idOffice") Long idOffice, @Param("idPerson") Long idPerson);
    ...
    boolean hasCanAccessWorkpack(@Param("idOffice") Long idOffice, @Param("idPerson") Long idPerson);
    ...
    Set<CanAccessOffice> findInheritedPermission(Long workpackId, Long personId);
