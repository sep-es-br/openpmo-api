...
@Component
public class FindAllAgreementUsingCustomFilter extends FindAllUsingCustomFilterBuilder {

  private final AgreementRepository repository;

  public FindAllAgreementUsingCustomFilter(final AgreementRepository repository) {
  ...
  @Override protected void buildMatchClause(final CustomFilter filter, final StringBuilder query) {
    query.append("MATCH (").append(this.nodeName)
      .append(":Agreement)-[relationship:SIGNED_FOR]->(workpack:Workpack) ");
  }
