...
@RestController
@CrossOrigin
@RequestMapping("/filter/domains")
public class FilterDomainController extends CreateAndUpdateUsingCommonFilterOperations {

  private final CustomFilterService customFilterService;

  @Autowired
  public FilterDomainController(final CustomFilterService customFilterService) {
