...
public class LocalityController {
  ...
  @Autowired
  public LocalityController(final LocalityService localityService, final ModelMapper modelMapper) {
  ...
  @GetMapping("{id}")
  public ResponseEntity<ResponseBase<LocalityDetailDto>> findById(@PathVariable final Long id) {
    final LocalityDetailDto localityDto = this.modelMapper.map(
      this.localityService.findById(id),
      LocalityDetailDto.class
    );
    final ResponseBase<LocalityDetailDto> response = new ResponseBase<LocalityDetailDto>().setData(localityDto)
      .setSuccess(true);
