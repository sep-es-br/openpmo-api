...
@RestController
@CrossOrigin
@RequestMapping("/filter/unitMeasures")
public class FilterUnitMeasuresController extends CreateAndUpdateUsingCommonFilterOperations {

  private final CustomFilterService customFilterService;
  private final TokenService tokenService;

  @Autowired
  public FilterUnitMeasuresController(final CustomFilterService customFilterService, final TokenService tokenService) {
  ...
  protected CustomFilterEnum getFilter() {
    return CustomFilterEnum.UNIT_MEASURES;
  }
}
