...
@RestController
@CrossOrigin
@RequestMapping("/filter/office-permissions")
public class FilterOfficePermissionController extends CreateAndUpdateUsingCommonFilterOperations {

  private final CustomFilterService customFilterService;

  @Autowired
  public FilterOfficePermissionController(final CustomFilterService customFilterService) {
