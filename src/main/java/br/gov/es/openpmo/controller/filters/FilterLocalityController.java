...
@RestController
@CrossOrigin
@RequestMapping("/filter/localities")
public class FilterLocalityController extends CreateAndUpdateUsingCommonFilterOperations {

  private final CustomFilterService customFilterService;

  @Autowired
  public FilterLocalityController(final CustomFilterService customFilterService) {
