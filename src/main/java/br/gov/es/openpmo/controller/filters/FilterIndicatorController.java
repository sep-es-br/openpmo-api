...
@RestController
@CrossOrigin
@RequestMapping("/filter/workpackModels/{idWorkpackModel}/indicators")
public class FilterIndicatorController extends CreateAndUpdateUsingWorkpackModelFilterOperations {

    private final CustomFilterService customFilterService;
    private final TokenService tokenService;

    @Autowired
    public FilterIndicatorController(
    ...
    protected CustomFilterEnum getFilter() {
        return CustomFilterEnum.INDICATOR;
    }
}
