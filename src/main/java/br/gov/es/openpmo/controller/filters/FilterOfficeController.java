...
@RestController
@CrossOrigin
@RequestMapping("/filter/offices")
public class FilterOfficeController extends CreateAndUpdateUsingCommonFilterOperations {

  private final CustomFilterService customFilterService;
  private final TokenService tokenService;

  @Autowired
  public FilterOfficeController(final CustomFilterService customFilterService, final TokenService tokenService) {
  ...
  protected CustomFilterEnum getFilter() {
    return CustomFilterEnum.OFFICE;
  }
}
