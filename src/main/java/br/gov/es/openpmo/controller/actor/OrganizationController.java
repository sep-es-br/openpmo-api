...
public class OrganizationController {
  ...
  public ResponseEntity<ResponseBase<List<OrganizationDto>>> indexBase(
    ...
    final ResponseBase<List<OrganizationDto>> response = new ResponseBase<List<OrganizationDto>>().setData(organizations)
  ...
  public ResponseEntity<ResponseBase<OrganizationDto>> findById(@PathVariable final Long id) {
    ...
    final ResponseBase<OrganizationDto> response = new ResponseBase<OrganizationDto>().setData(officeDto).setSuccess(true);
    return ResponseEntity.ok(response);
  }

  @PostMapping
  public ResponseEntity<ResponseBase<EntityDto>> save(@Valid @RequestBody final OrganizationStoreDto organizationStoreDto) {
