...
@RestController
@CrossOrigin
@RequestMapping("/filter/workpackModels/{idWorkpackModel}/processes")
public class FilterProcessController extends CreateAndUpdateUsingWorkpackModelFilterOperations {

  private final CustomFilterService customFilterService;

  @Autowired
  public FilterProcessController(final CustomFilterService customFilterService) {
