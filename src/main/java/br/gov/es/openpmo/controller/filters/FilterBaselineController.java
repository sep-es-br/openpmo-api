...
@RestController
@CrossOrigin
@RequestMapping("/filter/baselines")
public class FilterBaselineController extends CreateAndUpdateUsingCommonFilterOperations {
  ...
  @Autowired
  public FilterBaselineController(
  ...
  protected CustomFilterEnum getFilter() {
    return CustomFilterEnum.BASELINE;
  }
