...
@RestController
@CrossOrigin
@RequestMapping("/filter/workpackModels/{idWorkpackModel}/procurements")
public class FilterProcurementController extends CreateAndUpdateUsingWorkpackModelFilterOperations {

  private final CustomFilterService customFilterService;
  private final TokenService tokenService;

  @Autowired
  public FilterProcurementController(
  ...
  protected CustomFilterEnum getFilter() {
    return CustomFilterEnum.PROCUREMENT;
  }
}
