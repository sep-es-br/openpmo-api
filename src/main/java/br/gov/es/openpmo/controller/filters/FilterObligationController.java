...
@RestController
@CrossOrigin
@RequestMapping("/filter/workpackModels/{idWorkpackModel}/obligations")
public class FilterObligationController extends CreateAndUpdateUsingWorkpackModelFilterOperations {

  private final CustomFilterService customFilterService;
  private final TokenService tokenService;

  @Autowired
  public FilterObligationController(
  ...
  protected CustomFilterEnum getFilter() {
    return CustomFilterEnum.OBLIGATION;
  }
}
