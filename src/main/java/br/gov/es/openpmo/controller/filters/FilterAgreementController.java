...
@RestController
@CrossOrigin
@RequestMapping("/filter/workpackModels/{idWorkpackModel}/agreements")
public class FilterAgreementController extends CreateAndUpdateUsingWorkpackModelFilterOperations {

  private final CustomFilterService customFilterService;
  private final TokenService tokenService;

  @Autowired
  public FilterAgreementController(
  ...
  protected CustomFilterEnum getFilter() {
    return CustomFilterEnum.AGREEMENT;
  }
}
