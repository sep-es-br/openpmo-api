...
public class ApplicationMessage {
  ...
  public static final String PROJECT_STATUS_CANNOT_CHANGE_WITHOUT_APPROVED_BASELINE = "project.status.cannot.change.without.approved.baseline";
  ...
  public static final String REPORT_DESIGN_MAIN_FILE_TEMPLATE_QUANTITY_DIFFERENT_THAN_ONE = "report-design.file-template.main.quantity.cannot.be.different-than-one";
  ...
  public static final String REPORT_DESIGN_COMPILED_ERROR = "report-design.file-template.compiled.error";
